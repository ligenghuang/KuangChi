...
public class CarryActivity extends UserBaseActivity<CarryAction> implements CarryView {
    ...
    CarryListAdapter carryListAdapter;
    ...
    @Override
    protected CarryAction initAction() {
        return new CarryAction(this, this);
    }
    ...
    protected void initTitlebar() {
        ...
        mImmersionBar
                ...
                .addTag("CarryActivity")  //给上面参数打标记，以后可以通过标记恢复
                .navigationBarWithKitkatEnable(false)
                .init();
        toolbar.setNavigationOnClickListener(view -> finish());
        fTitleTv.setText(ResUtil.getString(R.string.my_tab_4));
    }
    ...
    protected void init() {
        ...
        carryTimer = new MyCountDownTimer(3600000,1000);

//        //初始化适配器
        carryListAdapter = new CarryListAdapter(mContext);
     ...
     */
    @Override
    public void getCarryListSuccess(CarryListDto carryListDto) {
        loadDiss();
        if (carryTimer != null){
            carryTimer.cancel();
        }
        ...
        CarryListDto.DataBeanX dataBean = carryListDto.getData();
