...
public class FindLoginPwdActivity extends UserBaseActivity<MoblieLoginPwdAction> implements MoblieLoginPwdView {
    ...
    public void getAuthCode() {
        if (TextUtils.isEmpty(tvPwdMobile.getText().toString())){
        ...
        if (CheckNetwork.checkNetwork2(mContext)) {
            loadDialog();
            baseAction.getAuthCode(tvPwdMobile.getText().toString());
        }
    }
    ...
    private void submit() {
        ...
        pwdPost.setPhone(tvPwdMobile.getText().toString());
        //todo 判断是否输入验证码
