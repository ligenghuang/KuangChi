...
public class LoginAction extends BaseAction<LoginView> {
     ...
     */
    public void LoginOrRegistered(String phone,String verify_code,int inviteCode){
        Map<Object,Object> map = new HashMap<>();
        if (inviteCode == 0){
            map = CollectionsUtils.generateMap("phone",phone,"verify_code",verify_code);
        }else {
            map = CollectionsUtils.generateMap("phone",phone,"verify_code",verify_code,"inviteCode",inviteCode);
        }
